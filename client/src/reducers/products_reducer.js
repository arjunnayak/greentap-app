import { GET_PRODUCTS, GET_PRODUCT, ADD_PRODUCT_SUBMIT, ADD_PRODUCT_SUCCESS, EDIT_PRODUCT, LOAD_EDIT_PRODUCT, DELETE_PRODUCT, PRODUCT_ERROR, CLEAR_PRODUCT } from '../actions/types';
