...
API_HOST = 'http://ec2-52-53-193-187.us-west-1.compute.amazonaws.com:3001/api'
...
file_path = '/Users/arjunnayak/Downloads/all_products_live_5-25.csv'
columns = [ 'product_image','category','sub_category','product_name','short_description', 'product_description',
  'strain_type','thc_level', 'cbd_level','unit_count','unit_price','unit_count_type','brand_name','state', 'brand_description', 'brand_logos' ]
